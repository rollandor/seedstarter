...
const Navbar = () => {
    ...
    <div class='gap-1 h-20 mb-1 bg-teal-200 flex flex-row justify-between items-center'>
      <div class='ml-1 h-[90%] w-3/4 bg-teal-400'>
        ...
        <div class='h-1/2 bg-teal-400'>
          <ul class='h-full w-full flex justify-center items-center'>
            <li class='mx-10 '>Dashboard</li>
            <li class='mx-10'>Buy token</li>
            <li class='mx-10'>About</li>
          </ul>
        </div>
      </div>
  ...
  // return (
  //   <header class="seedstarter-navbar">
