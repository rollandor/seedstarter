...
import { notification, getBlockExplorerTxLink, getParsedError } from "@/utils";
 ...
 * 
 * @param _walletClient - Optional wallet client to use. If not provided, will 
 * use the one from useWalletClient.
 * @returns function that takes in transaction function as callback, shows 
 * UI feedback for transaction and returns a promise of the transaction hash
 */
