...
import { OutViaWallet } from "../PaymentProcessOffer/PaymentProcessOffer";
...
function PaymentProcessExecution({ 
  ...
  const buyToken = async() => {
    ...
    const sds = new ethers.Contract(process.env.SDS_ADDR, SeedstarterABI, web3Provider);
    const presale = new ethers.Contract(process.env.SDS_PRESALE_ADDR, PresellerABI, signer);
